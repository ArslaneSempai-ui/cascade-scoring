...
<!-- figures:tests -->
<<<<<<< HEAD
**71 tests** across 7 files, counted by running the suite rather than typed here.
=======
**44 tests** across 5 files, counted by running the suite rather than typed here.
>>>>>>> facteurs
<!-- /figures:tests -->
