...
APART and never merged. Commit `a7dc0ee`, 2026-09-07. Sealed as `releve-public.json`;
...
No cell holds a recall lower bound of 90 % on the written dossiers, and the report says so.
